...
public class RacaController {
	...
	public ResponseEntity<Raca> findById(@PathVariable Integer idRaca) {
	...
	public ResponseEntity<Raca> update(@PathVariable Integer idRaca, @RequestBody Raca raca) {
		Raca obj = service.update(idRaca, raca);
		return ResponseEntity.ok().body(obj);
	}

	@DeleteMapping(value = "/{idRaca}")
	public ResponseEntity<Raca> delete(@PathVariable Integer idRaca) {
